#  В модели офис есть столбец с названием parent_office, в котором лежат айди других офисов. 
#  Проблема заключалась в том что можно сделать петлю офисов. Проблема была решена с помощью рекурсии
